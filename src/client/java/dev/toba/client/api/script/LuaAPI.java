...
public class LuaAPI {
    ...
    public static void bind(Globals g) {
        g.set("player",     playerTable());
        g.set("world",      worldTable());
        g.set("game",       gameTable());
        g.set("chat",       chatTable());
        g.set("imgui",      imguiTable());
        g.set("modules",    modulesTable());
        g.set("rotation",   rotationTable());
        g.set("pathfinder", pathfinderTable());
        g.set("esp",        espTable());
        g.set("entities",   entitiesTable());
        g.set("inventory",  inventoryTable());
        g.set("action",     actionTable());
        g.set("movement",   movementTable());
        g.set("input",      inputTable());
        g.set("tablist",    tablistTable());
        g.set("bazaar",     bazaarTable());
        g.set("scoreboard", scoreboardTable());
        g.set("screen",     screenTable());
